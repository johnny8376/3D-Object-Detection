...
int roi_align_forward_cuda(int aligned_height, int aligned_width, int aligned_length, float spatial_scale,
                        THCudaTensor * features, THCudaTensor * rois, THCudaTensor * output)
{
    ...
    ROIAlignForwardLaucher(
        ...
        data_width, data_length, num_channels, aligned_height,
        aligned_width, aligned_length, rois_flat,
        output_flat, stream);

    return 1;
}

int roi_align_backward_cuda(int aligned_height, int aligned_width, int aligned_length, float spatial_scale,
