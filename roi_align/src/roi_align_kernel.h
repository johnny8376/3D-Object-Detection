...
__global__ void ROIAlignForward(const int nthreads, const float* bottom_data,
    const float spatial_scale, const int height, const int width, const int length,
    const int channels, const int aligned_height, const int aligned_width, const int aligned_length,
...
int ROIAlignForwardLaucher(
    ...
    const int width, const int length, const int channels, const int aligned_height,
    const int aligned_width, const int aligned_lenth, const float* bottom_rois,
...
int ROIAlignBackwardLaucher(const float* top_diff, const float spatial_scale, const int batch_size, const int num_rois,
    const int height, const int length, const int width, const int channels, const int aligned_height,
    const int aligned_width, const int aligned_length, const float* bottom_rois,
